(function() {
 ...
 if ( ( typeof expandProperties.width != "undefined" ) && ( expandProperties.width != null )&& ( expandProperties.width > 0 ) ) {
 cmd += ", 'width', '" +expandProperties.width + "'";
 }         
 else if ( ( typeof dimensions.width != "undefined" ) && ( dimensions.width != null ) ) {
 cmd += ", 'width', '" + dimensions.width + "'";
 }
 
 if ( ( typeof expandProperties.height != "undefined" ) && ( expandProperties.height != null )  && ( expandProperties.height > 0 ) ) {
 cmd += ", 'height', '" +expandProperties.height + "'";
 }                     
 else if ( ( typeof dimensions.height != "undefined" ) && ( dimensions.height != null ) ) {
 cmd += ", 'height', '" + dimensions.height + "'";
 }
 ...
 if((!dimensions) || typeof dimensions.mraid != "undefined" )
 {
 if ( ( typeof expandProperties.useCustomClose == "undefined" ) || (expandProperties.useCustomClose == null) || ( expandProperties.useCustomClose == false) || ( expandProperties.useCustomClose == 'false' )) {
 cmd += ", 'useCustomClose', 'false'";
 }                          
 }
 cmd += " );";
 eval( cmd );
 ...
 this.executeNativeCall( "shake",
                        "properties", properties); 
 };
 
 ormmaview.playVideo = function(URL, properties) {
    var cmd = "this.executeNativeCall( 'video'";
    ...
    for(_item in properties) {
        var obj = properties[_item];
        if( obj.toString() === '[object Object]' ) {
            for(_subItem in obj) {
                cmd += ", '"+_subItem+"', '" + obj[_subItem] + "'";
            }
        } else {
            cmd += ", '"+_item+"', '" + obj + "'";
        }
 ...
 var cmd = "this.executeNativeCall( 'audio'";
