...
/*
 * 2012-08-07 - Sven Ewert
 *
 * Various changes to optimize to run with the GUJBaseSDK.
 * Transformed to be ARC compatible.
 * Many thanks Stijn! ... cool class :)
 */	
#import <UIKit/UIKit.h>
@interface GUJAnimatedGifQueueObject : NSObject
{
    UIImageView *uiv;
    NSURL *url;
}
...
@interface GUJAnimatedGif : NSObject
{
	NSData *GIF_pointer;
