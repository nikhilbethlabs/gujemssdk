 ...
 * 
 * A response may contain different types of ads: rich media,
 * image only or empty.
 * 
 * For image only ads, a parser can be used which holds the image url,
 * click url and possible tracking url. Parsers are used for native views,
 * i.e. ImageViews instead of WebViews for better performance.
 * 
 * @author stein16
 *
 */
